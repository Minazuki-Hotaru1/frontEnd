  ...
  <div class="admin-page">
    ...
    >
      ...
      >
        <template #default="scope">
          <el-link
            type="primary"
            @click="openAddressDialog(scope.row.address)"
          >
            <el-tooltip
              class="box-item"
              effect="dark"
      ...
      >
        <template #default="scope">
          <el-button
            ...
            type="success"
            class="button1"
            @click="openPassConfirmDialog(scope.row)"
          >
            确认
          </el-button>
          <br />
          <el-button
            ...
            type="danger"
            class="button1"
            @click="openUnPassConfirmDialog(scope.row)"
          >
            不通过
          </el-button>
        </template>
    ...
    >
      <div class="confirm-dialog">
        <p>确认通过该企业用户申请吗？</p>
        <p v-if="selectedRow">
          <strong>企业名称：</strong>{{ selectedRow.roles }}
        </p>
        <p v-if="selectedRow">
          <strong>账号：</strong>{{ selectedRow.username }}
        </p>
      </div>
      ...
      <template #footer>
        ...
        <el-button
          type="success"
          @click="enterprisePass(selectedRow?.id)"
          >确认</el-button
        >
      </template>
    </el-dialog>
    ...
    >
      ...
      <template #footer>
        ...
        <el-button
          type="danger"
          @click="enterpriseUnPass(selectedRow)"
          >确认</el-button
        >
      </template>
    </el-dialog>
