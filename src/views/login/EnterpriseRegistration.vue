<template>
    ...
    <form @submit.prevent="handleSubmit">
        <el-card style="max-width: 480px">
            ...
            <el-form-item label="注册用户选择" class="item1">
                <el-select v-model="form.region" placeholder="选择您注册的角色">
                    <el-option label="医院" value="101" />
                    <el-option label="停车场" value="102" />
                    <el-option label="共享自行车" value="103" />
                    <el-option label="公园" value="104" />
                    <el-option label="充电桩停车场" value="105" />
                    <el-option label="其他" value="106" />
                </el-select>
            </el-form-item>
            <div class="wave-group">
                <input placeholder=" " type="text" class="input" v-model="form.username">
                <span class="bar"></span>
                <label class="label">
            ...
            <div class="wave-group margin-top">
                <input placeholder=" " type="text" class="input" v-model="form.password">
                <span class="bar"></span>
                <label class="label">
            ...
            <div class="wave-group margin-top">
                <input placeholder=" " type="text" class="input" v-model="form.roles">
                <span class="bar"></span>
                <label class="label">
                    <span class="label-char" style="--index: 0">企</span>
                    <span class="label-char" style="--index: 1">业</span>
                    <span class="label-char" style="--index: 1">名</span>
                    <span class="label-char" style="--index: 1">字</span>
                    <span class="label-char" style="--index: 1">信</span>
                    <span class="label-char" style="--index: 1">息</span>
                </label>
            </div>
            <div class="wave-group margin-top">
                <input placeholder=" " type="text" class="input" v-model="form.address">
                <span class="bar"></span>
                <label class="label">
                    <span class="label-char" style="--index: 0">企</span>
                    <span class="label-char" style="--index: 1">业</span>
                    <span class="label-char" style="--index: 1">具</span>
                    <span class="label-char" style="--index: 1">体</span>
